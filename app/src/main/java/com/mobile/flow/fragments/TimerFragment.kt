...
class TimerFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        TimerService.Companion.appOpened(requireContext())
    ...
    private fun startTimer() {
        ...
        TimerService.Companion.startTimer(requireContext(), "focus", sessionInfo)
    }
    ...
    private fun pauseTimer() {
        ...
        TimerService.Companion.stopTimer(requireContext())
    }
    ...
    private fun showPresetDialog() {
        ...
        val adapter = TimerPresetAdapter(presets) { preset ->
            ...
            val sharedPreferences =
                requireContext().getSharedPreferences("PomodoroSettings", Context.MODE_PRIVATE)
            sharedPreferences.edit().apply {
    ...
    private fun loadPresets(): List<TimerPreset> {
        ...
        val type = object : com.google.gson.reflect.TypeToken<List<TimerPreset>>() {}.type
